...
> - **[Conversations PRD](conversations-prd_V1.md)** — The Conversation, Topic, and Project entity types, the organizational hierarchy, AI intelligence layer (classify & route, summarize, extract intelligence), conversation lifecycle, cross-channel stitching, segmentation, and the review workflow.
> 
...
7. [Communication Entry Points](#7-communication-entry-points)
8. [Provider Account Framework](#8-provider-account-framework)
9. [Provider Adapter Architecture](#9-provider-adapter-architecture)
10. [Communication Participants & Contact Resolution](#10-communication-participants--contact-resolution)
11. [Triage & Intelligent Filtering](#11-triage--intelligent-filtering)
12. [Attachments](#12-attachments)
13. [Multi-Account Management](#13-multi-account-management)
14. [Event Sourcing & Temporal History](#14-event-sourcing--temporal-history)
15. [Virtual Schema & Data Sources](#15-virtual-schema--data-sources)
16. [Search & Discovery](#16-search--discovery)
17. [Storage & Data Retention](#17-storage--data-retention)
18. [Privacy, Security & Compliance](#18-privacy-security--compliance)
19. [API Design](#19-api-design)
20. [Design Decisions](#20-design-decisions)
21. [Phasing & Roadmap](#21-phasing--roadmap)
22. [Dependencies & Related PRDs](#22-dependencies--related-prds)
23. [Open Questions](#23-open-questions)
24. [Future Work](#24-future-work)
25. [Glossary](#25-glossary)
26. [Appendix A: PoC Implementation Reference](#appendix-a-poc-implementation-reference)
...
| Triage classification               | On sync, on creation | Runs the multi-layer triage pipeline (Section 11) to classify communications as real interactions vs. automated/marketing noise.                                                                                       |
...
| Channel          | Content Length               | Content Quality                   | Auto-captured?   |
| ---------------- | ---------------------------- | --------------------------------- | ---------------- |
| `email`          | Medium-long (50–5,000 words) | High (structured, detailed)       | Yes              |
| `sms` / `mms`    | Very short (1–50 words)      | Low (terse, context-dependent)    | Yes              |
| `phone_recorded` | Long (500–10,000 words)      | Medium (conversational, rambling) | Yes (transcript) |
| `phone_manual`   | Variable (user-written)      | High (user curates)               | No               |
| `video_recorded` | Long                         | Medium (same as phone)            | Yes (transcript) |
| `video_manual`   | Variable (user-written)      | High (user curates)               | No               |
| `in_person`      | Variable (user-written)      | High (user curates)               | No               |
| `note`           | Variable (user-written)      | High (user curates)               | No               |
...
## 8. Provider Account Framework

### 8.1 Provider Account Data Model
...
### 8.2 Provider Account Operations
...
### 8.3 Personal vs. Shared Accounts
...
## 10. Communication Participants & Contact Resolution

### 10.1 Participant Relation Type
...
### 10.3 Integration with Contact Intelligence System
...
### 10.4 Identifier Types by Channel
...
### 10.5 Pending Identification State
...
### 10.6 Cross-Channel Contact Unification
...
## 11. Triage & Intelligent Filtering
...
### 11.3 Channel-Specific Heuristics
...
### 12.3 Recording-Transcript Relationship
...
### 13.2 Cross-Account Considerations
...
## 15. Virtual Schema & Data Sources

### 15.1 Communication Virtual Schema Table
...
| **Conversations PRD**                | Conversations group Communications. Communications reference their parent Conversation via `conversation_id`.                                            | **Communications is foundational.** Conversations depend on the Communication entity and its common schema.         |
...
| **Notes PRD**                        | Notes attach to Communications as supplementary commentary.                                                                                              | **Notes depend on Communications** as an attachment target.                                                         |
