...
| Communications | 2.0 | `communications-prd_V2.md` | Draft — Reconciled with Custom Objects | 2026-02-19 |
| Conversations | 3.0 | `conversations-prd_V3.md` | Draft — Reconciled with Custom Objects | 2026-02-19 |
...
| Views & Grid | 4.0 | `views-grid-prd_V4.md` | Draft — Complete + AGI cross-references | 2026-02-20 |
...
| Adaptive Grid Intelligence | 1.0 | `adaptive-grid-intelligence-prd_V1.md` | Draft — Initial specification | 2026-02-20 |
...
| Views & Grid PRD V3 | `views-grid-prd_V3.md` | `views-grid-prd_V4.md` | 2026-02-20 |
...
- Column system (direct, relation traversal, computed) — extended by [Adaptive Grid Intelligence PRD](adaptive-grid-intelligence-prd_V1.md) for content-aware auto-sizing
...
**File:** `adaptive-grid-intelligence-prd_V1.md`
**Scope:** Intelligent layout engine that automatically optimizes the entire workspace (grid columns, detail panel, navigation sidebar) based on display characteristics, data content analysis, and user preferences. Transforms the grid from static, manually-configured layouts into a self-optimizing workspace that adapts to the user's monitor, data, and workflow.

**Key sections:**

- Display detection & viewport analysis (display profiles, DPI heuristics, density tier classification)
- Workspace space budget engine (three-zone allocation: action panel, grid, detail panel)
...
- Preview panel intelligence (width and internal density adaptation based on content and preference)
- Navigation sidebar adaptation (content-aware width)
...
- View settings extensions (preview panel size, auto-density, column auto-sizing, column demotion toggles)
...
- **Unified workspace budget** — Grid, preview panel, and nav sidebar participate in a single space allocation
...
**Alignment with Views & Grid PRD:** Extends column configuration (Section 8.3), field type display renderers (Section 9.1), and view persistence (Section 17). The Views & Grid PRD V4 includes cross-references to this document. Default column widths in the Views & Grid PRD serve as fallbacks when auto-sizing is disabled.

**Alignment with GUI Functional Requirements PRD:** Extends the four-zone layout (Section 4), splitter behavior (Section 4.3), detail panel (Section 8), responsive breakpoints (Section 21), and density settings (Section 23.3). Display tiers refine the breakpoint system. Auto-density adds an "auto" mode to the existing compact/standard/comfortable options.
