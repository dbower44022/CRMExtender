...
Contact (event-sourced)
  ...
  ├── Custom fields: tenant-configurable typed fields
...
### 5.2 Contact Record — Materialized View
...
- `companies_current` — Company records referenced by contacts.
...
2. **Custom field limits** — How many custom fields per entity per tenant? Impacts schema flexibility vs. query performance. Consider 50-field limit with performance testing.
