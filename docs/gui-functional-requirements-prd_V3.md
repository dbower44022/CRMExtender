...
When a user clicks on a row, the row is selected and highlighted and the check box becomes selected.

If a user holds the Shift Key and clicks on a second row, all rows between the last selected row, and the clicked row become selected and the checkbox also becomes selected.

If a user holds the Ctrl Key and click on a second row, the row becomes selected the same as a normal click.

The row selection function should match industry standards so users find the process intuitive.
...
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Click a row**           | Row is selected (highlighted), Docked Window updates to show that record in Preview Mode, the selection checkbox is selected.                             |
...
When two or more rows are selected, the Primary Action Buttons transition into Bulk Action Buttons.
