...
> **V10.0 (2026-02-23):** Added Product TDD and Contact Entity TDD to status tracking. Added Contact Entity Base PRD and six Contact Action Sub-PRDs as hierarchical children of Contact Management. Updated methodology guide to V2. Added new terms to glossary (V4). Updated template-tdd to V2 (living document approach) and template-product-tdd to V2 (matches actual structure).
...
|---|---|---|---|---|
| **Product Level** | | | | |
| PRD Methodology Guide | 2.0 | `prd-methodology-guide_V2.md` | Updated — Key Processes, field metadata, † convention | 2026-02-23 |
| Product TDD | 1.0 | `product-tdd_V1.md` | Draft — 13 sections, living document | 2026-02-23 |
...
| └ Contact Entity Base | 9.0 | `contact-entity-base-prd_V9.md` | Draft — V2 methodology (field metadata, Key Processes) | 2026-02-23 |
| &nbsp;&nbsp;└ Contact Entity TDD | 1.0 | `contact-entity-tdd_V1.md` | Draft — Living document, 9 sections | 2026-02-23 |
| └ Identity Resolution | 2.0 | `contact-identity-resolution-prd_V2.md` | Draft — Key Processes added | 2026-02-23 |
| └ Merge & Split | 2.0 | `contact-merge-split-prd_V2.md` | Draft — Key Processes added | 2026-02-23 |
| └ Import & Export | 2.0 | `contact-import-export-prd_V2.md` | Draft — Key Processes added | 2026-02-23 |
| └ Enrichment | 2.0 | `contact-enrichment-prd_V2.md` | Draft — Key Processes added | 2026-02-23 |
| └ AI Intelligence | 2.0 | `contact-ai-intelligence-prd_V2.md` | Draft — Key Processes added | 2026-02-23 |
| └ Relationship Intelligence | 2.0 | `contact-relationship-intelligence-prd_V2.md` | Draft — Key Processes added | 2026-02-23 |
...
| Master Glossary | 4.0 | `glossary_V4.md` | Active — Key Process, field metadata, † caching terms added | 2026-02-23 |
...
| Glossary V1-V3 | `glossary_V1.md`, `glossary_V2.md`, `glossary_V3.md` | `glossary_V4.md` | 2026-02-23 |
...
| PRD Index V1-V9 | `prd-index_V8.md`, `prd-index_V9.md` | `prd-index_V10.md` | 2026-02-23 |
| Contact Entity Base V1-V6 | `contact-entity-base-prd_V6.md` | `contact-entity-base-prd_V9.md` | 2026-02-23 |
| Contact Identity Resolution V1 | `contact-identity-resolution-prd_V1.md` | `contact-identity-resolution-prd_V2.md` | 2026-02-23 |
| Contact Merge & Split V1 | `contact-merge-split-prd_V1.md` | `contact-merge-split-prd_V2.md` | 2026-02-23 |
| Contact Import & Export V1 | `contact-import-export-prd_V1.md` | `contact-import-export-prd_V2.md` | 2026-02-23 |
| Contact Enrichment V1 | `contact-enrichment-prd_V1.md` | `contact-enrichment-prd_V2.md` | 2026-02-23 |
| Contact AI Intelligence V1 | `contact-ai-intelligence-prd_V1.md` | `contact-ai-intelligence-prd_V2.md` | 2026-02-23 |
| Contact Relationship Intelligence V1 | `contact-relationship-intelligence-prd_V1.md` | `contact-relationship-intelligence-prd_V2.md` | 2026-02-23 |
| PRD Methodology Guide V1 | `prd-methodology-guide.md` | `prd-methodology-guide_V2.md` | 2026-02-23 |
| PRD Index V9 | `prd-index_V9.md` | `prd-index_V10.md` | 2026-02-23 |
| Contact Entity Base PRD V1-V6 | `contact-entity-base-prd_V6.md` | `contact-entity-base-prd_V9.md` | 2026-02-23 |
| Contact Identity Resolution V1 | `contact-identity-resolution-prd_V1.md` | `contact-identity-resolution-prd_V2.md` | 2026-02-23 |
| Contact Merge & Split V1 | `contact-merge-split-prd_V1.md` | `contact-merge-split-prd_V2.md` | 2026-02-23 |
| Contact Import & Export V1 | `contact-import-export-prd_V1.md` | `contact-import-export-prd_V2.md` | 2026-02-23 |
| Contact Enrichment V1 | `contact-enrichment-prd_V1.md` | `contact-enrichment-prd_V2.md` | 2026-02-23 |
| Contact AI Intelligence V1 | `contact-ai-intelligence-prd_V1.md` | `contact-ai-intelligence-prd_V2.md` | 2026-02-23 |
| Contact Relationship Intelligence V1 | `contact-relationship-intelligence-prd_V1.md` | `contact-relationship-intelligence-prd_V2.md` | 2026-02-23 |
| Glossary V1-V3 | `glossary_V3.md` | `glossary_V4.md` | 2026-02-23 |
| PRD Methodology Guide V1 | `prd-methodology-guide.md` | `prd-methodology-guide_V2.md` | 2026-02-23 |
...
|---|---|---|---|
| Contact Entity Base PRD | `contact-entity-base-prd_V9.md` | 9.0 | Entity definition, field registry with Editable/Sortable/Filterable metadata, relationships, lifecycle, Key Processes, action catalog |
| Contact Entity TDD | `contact-entity-tdd_V1.md` | 1.0 | Read model, identifier model, employment history, display name, status transitions, phone normalization. Living document with Claude Code placeholder section. |
| Identity Resolution Sub-PRD | `contact-identity-resolution-prd_V2.md` | 2.0 | Multi-identifier matching, confidence scoring, Key Processes |
| Merge & Split Sub-PRD | `contact-merge-split-prd_V2.md` | 2.0 | Contact merge/split workflows, audit trails, Key Processes |
| Import & Export Sub-PRD | `contact-import-export-prd_V2.md` | 2.0 | CSV import, Google Contacts sync, export formats, Key Processes |
| Enrichment Sub-PRD | `contact-enrichment-prd_V2.md` | 2.0 | Apollo/Clearbit/PDL adapters, enrichment pipeline, Key Processes |
| AI Intelligence Sub-PRD | `contact-ai-intelligence-prd_V2.md` | 2.0 | AI briefings, tag suggestions, NL search, Key Processes |
| Relationship Intelligence Sub-PRD | `contact-relationship-intelligence-prd_V2.md` | 2.0 | Neo4j graph, relationship scoring, influence mapping, Key Processes |
...
| File | Source |
|---|---|
| `product-tdd_V1.md` | Created 2026-02-23 (global technology decisions, 13 sections, living document) |
| `contact-entity-tdd_V1.md` | Created 2026-02-23 (Contact entity technical decisions, living document with Claude Code placeholder) |
| `contact-entity-base-prd_V9.md` | Created 2026-02-23 (V2 methodology: field metadata with Editable/Sortable/Filterable, Key Processes, † caching convention) |
| `contact-identity-resolution-prd_V2.md` | Created 2026-02-23 (Key Processes added) |
| `contact-merge-split-prd_V2.md` | Created 2026-02-23 (Key Processes added) |
| `contact-import-export-prd_V2.md` | Created 2026-02-23 (Key Processes added) |
| `contact-enrichment-prd_V2.md` | Created 2026-02-23 (Key Processes added) |
| `contact-ai-intelligence-prd_V2.md` | Created 2026-02-23 (Key Processes added) |
| `contact-relationship-intelligence-prd_V2.md` | Created 2026-02-23 (Key Processes added) |
| `prd-methodology-guide_V2.md` | Created 2026-02-23 (Key Processes, field metadata, † convention, TDD living document approach) |
| `glossary_V4.md` | Created 2026-02-23 (Key Process, field metadata, † caching convention terms) |
| `template-tdd_V2.md` | Created 2026-02-23 (living document approach: your decisions, Claude Code decisions, placeholder section) |
| `template-product-tdd_V2.md` | Created 2026-02-23 (updated to match actual product-tdd structure) |
...
| `prd-index_V10.md` | This file (replaces V9) |
...
| `glossary_V1.md` | Superseded by V4 |
| `glossary_V2.md` | Superseded by V4 |
| `glossary_V3.md` | Superseded by V4 |
| `prd-index_V3.md` through `prd-index_V9.md` | Superseded by V10 |
| `prd-methodology-guide.md` | Superseded by `prd-methodology-guide_V2.md` |
| `contact-entity-base-prd_V6.md` | Superseded by V9 |
| `contact-identity-resolution-prd_V1.md` | Superseded by V2 |
| `contact-merge-split-prd_V1.md` | Superseded by V2 |
| `contact-import-export-prd_V1.md` | Superseded by V2 |
| `contact-enrichment-prd_V1.md` | Superseded by V2 |
| `contact-ai-intelligence-prd_V1.md` | Superseded by V2 |
| `contact-relationship-intelligence-prd_V1.md` | Superseded by V2 |
| `product-tdd.md` | Superseded by `product-tdd_V1.md` (versioned filename) |
| `contact-entity-tdd.md` | Superseded by `contact-entity-tdd_V1.md` (versioned filename) |
| `template-tdd_V1.md` | Superseded by V2 |
| `template-product-tdd_V1.md` | Superseded by V2 |
